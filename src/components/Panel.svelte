<script>
    ...
    <div class="row">
        <div class="col">
          <p>Boletas <small>{venta.boletas.length}</small></p>
          <div>
            {#each venta.boletas as item}
             <BotonVenta 
             tipo_doc={'boleta'}
             folio = {item[4]}
             interno = {item[0]}
        ...
        <div class="col">
          <p>Facturas <small>{venta.facturas.length}</small></p>
          <div>
            {#each venta.facturas as item}
              <BotonVenta 
              tipo_doc={'factura'}
              folio = {item[2]}
              interno = {item[0]}
        ...
        <div class="col">
          <p>Guias <small>{venta.guias.length}</small></p>
          <div>
            {#each venta.guias as item}
            <BotonVenta 
             tipo_doc={'guia'}
             folio = {item[0]}
             interno = {item[1]}
